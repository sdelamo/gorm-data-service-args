...
class BootStrap {
    ...
    public final static List< Map<String, String> > MICRONAUT = [
            [
                    title: 'Building Microservices with Micronaut®',
                    author: 'Nirmal Singh and Zack Dawood',
                    href: 'https://www.packtpub.com/product/building-microservices-with-micronaut/9781800564237',
                    about: 'The open source Micronaut® framework is a JVM-based toolkit designed to create microservices quickly and easily. ',
                    image: 'building-microservices-with-micronaut.png'
            ]
    ] as List< Map<String, String> >
    ...
    def init = { servletContext ->
        Map<String, List<Map<String, String>>> all = [
                grails: GRAILS_BOOKS,
                groovy: GROOVY_BOOKS,
                micronaut: MICRONAUT
        ]
        for (String tenantId : all.keySet()) {
            for (Map<String, String> bookInfo : all[tenantId]) {
